...
<a href="./"><div style="background:#333;font-size:25px;color:white;padding:5px;"> Empleos Destacados</div></a>
<br>
...
?>
 ...
 <center>   <img src="<?php echo $img; ?>"  style="width:190px;height:190px;"></center>
...
<a href="index.php?action=addtocart&product_id=<?php echo $p->id; ?>&href=cat" class="btn btn-labeled btn-primary tip" title="A&ntilde;adir al carrito">
                <span class=""><i class="fas fa-briefcase"></i></span> Solicitar empleo</a>
<br>
<?php else:?>
...
<?php else:?>
  <div class="jumbotron">
  <h2>No hay  empleos destacados.</h2>
  <p>En la pagina principal solo se muestran  empleos marcados como destacados.</p>
  </div>
<?php endif; ?>
