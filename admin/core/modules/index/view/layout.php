    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">ORUS</a>
        </div>
...
?>
         <ul class="nav navbar-nav">
          <li><a href="../" target="_blank"><i class="fa fa-globe"></i> Ver empleos</a></li>
          </ul>
          <ul class="nav navbar-nav side-nav">
          <li><a href="./"><i class="fa fa-home"></i> Inicio</a></li>
          <li><a href="index.php?view=products"><i class="fa fa-briefcase"></i> Empleos</a></li>
          <li><a href="index.php?view=sells"><i class="fas fa-hard-hat"></i> Empleados</a></li>
          <li><a href="index.php?view=sellreport"><i class="fa fa-area-chart"></i> Reportes</a></li>
          <li><a href="index.php?view=clients"><i class="fa fa-male"></i> Empleadores</a></li>
